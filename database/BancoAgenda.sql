...
-- Copiando estrutura para tabela agenda.administradores
...
-- Copiando dados para a tabela agenda.administradores: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.alunos
...
-- Copiando dados para a tabela agenda.alunos: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.atendimentos_agendados
...
-- Copiando dados para a tabela agenda.atendimentos_agendados: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.cache
...
-- Copiando dados para a tabela agenda.cache: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.cache_locks
...
-- Copiando dados para a tabela agenda.cache_locks: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.disciplinas
...
-- Copiando dados para a tabela agenda.disciplinas: ~26 rows (aproximadamente)
...
-- Copiando estrutura para tabela agenda.disciplina_professor
...
-- Copiando dados para a tabela agenda.disciplina_professor: ~29 rows (aproximadamente)
...
-- Copiando estrutura para tabela agenda.eventos
...
-- Copiando dados para a tabela agenda.eventos: ~3 rows (aproximadamente)
...
-- Copiando estrutura para tabela agenda.failed_jobs
...
-- Copiando dados para a tabela agenda.failed_jobs: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.jobs
...
-- Copiando dados para a tabela agenda.jobs: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.job_batches
...
-- Copiando dados para a tabela agenda.job_batches: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.migrations
...
-- Copiando dados para a tabela agenda.migrations: ~0 rows (aproximadamente)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	(1, '0001_01_01_000000_create_users_table', 1),
	(2, '0001_01_01_000001_create_cache_table', 1),
	(3, '0001_01_01_000002_create_jobs_table', 1);

-- Copiando estrutura para tabela agenda.password_reset_tokens
...
-- Copiando dados para a tabela agenda.password_reset_tokens: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.professores
...
-- Copiando dados para a tabela agenda.professores: ~24 rows (aproximadamente)
...
-- Copiando estrutura para tabela agenda.representantes
...
-- Copiando dados para a tabela agenda.representantes: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.sessions
...
-- Copiando dados para a tabela agenda.sessions: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela agenda.turmas
...
-- Copiando dados para a tabela agenda.turmas: ~18 rows (aproximadamente)
...
-- Copiando dados para a tabela agenda.usuarios: ~2 rows (aproximadamente)
